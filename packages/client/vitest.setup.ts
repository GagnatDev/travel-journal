...
const nb = {
  ...
  notifications: {
    ...
    item: {
      ...
      tripNewEntryDigest: {
        title_one: '1 nytt innlegg i {{tripName}}',
        title_other: '{{count}} nye innlegg i {{tripName}}',
  ...
  trips: {
    ...
    notificationMode: {
      ...
      popoverTitle: 'Varsler om nye innlegg',
      perEntry: 'Varsle meg ved nye innlegg',
      perEntryDescription: 'Få push og innbokspost hver gang noen publiserer.',
      dailyDigest: 'Varsle meg én gang om dagen (kveld)',
      dailyDigestDescription: 'Ett sammendrag hver kveld dersom det finnes nye innlegg.',
      off: 'Ikke varsle meg',
      offDescription: 'Ingen push eller innbokspost for denne turen.',
      permissionRequired: 'Tillat varsler i nettleseren for å aktivere denne innstillingen.',
    },
  ...
  entries: {
    ...
    locationSectionLabel: 'Plassering',
    locationSourceOff: 'Ingen',
    locationSourceDevice: 'Nåværende posisjon',
    locationSourceExif: 'Første bilde (GPS i bildet)',
    locationFromPhotoHint:
      'Bruker GPS-metadata fra det første bildet i rekkefølgen (også etter omrokking).',
