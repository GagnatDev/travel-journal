...
const nb = {
  ...
  admin: {
    ...
    invite: {
      ...
      pendingCopyHint: 'Kopier invitasjonslenke (gyldig til utløp)',
  ...
  trips: {
    ...
    settings: {
      ...
      pendingInviteCopyHint: 'Kopier invitasjonslenke (gyldig til utløp)',
  ...
  entries: {
    ...
    uploadingPhotosTitle: 'Laster opp bilder',
    uploadFinishingTitle: 'Fullfører opplasting av bilder',
