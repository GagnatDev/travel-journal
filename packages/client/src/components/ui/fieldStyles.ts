...
/** Shared full-width inputs (border + focus ring). */
export const standardTextFieldClass = `w-full ${standardTextControlClass}`;
...
export const entryTextFieldClass = `w-full ${entryTextControlClass}`;
